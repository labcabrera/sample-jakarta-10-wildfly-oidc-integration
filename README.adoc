...
image::./resources/images/oidc-flow-c4-context-customer-search.png[]

En este caso simplemente utilizaremos la propagación del token OIDC obtenido en la aplicación web para consultar la API de clientes.

Creación de usuarios:

image::./resources/images/oidc-flow-c4-context-customer-creation.png[]
