...
aplicaciones basadas en Jakarta EE 10 y Jakarta Security 3 a través de OAuth2 y
OpenID Connect.
...
Antes de arrancar los proyectos es necesario configurar un Realm y un cliente en Keycloak para que se puedan autenticar los usuarios. Crearemos tres usuarios de ejemplo con
diferentes roles para probar la seguridad de los servicios.
