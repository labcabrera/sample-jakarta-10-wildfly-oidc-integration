...
Este repositorio contiene diferentes ejemplos para la integración de la
seguridad de aplicaciones basadas en Jakarta EE a través de OAuth2 y OpenID Connect.
...
Como IdP utilizaremos una imagen local de Keycloak.
